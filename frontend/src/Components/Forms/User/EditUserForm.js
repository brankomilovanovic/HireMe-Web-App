...
import { Role, getRoleTypes } from '../../../Constants/Role';
    ...
    return (
        <FormProvider {...form}>
            <form id='add-edit-user-form' action="#">
                ...
                { authUser?.role === Role.ADMIN && <SelectControl
                    value={values['role']}
                ...
                { watch('userType') === UserType.COMPANY && <div style={{display: 'flex', flexDirection: 'column', gap: '20px', marginTop: '10px'}}>
                    <TextFieldControl
                        name='companyName'
