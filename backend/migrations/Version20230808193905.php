 ...
 */
final class Version20230808193905 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ad_shift (id INT AUTO_INCREMENT NOT NULL, ad_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, shift INT NOT NULL, date_created DATETIME NOT NULL, date_updated DATETIME NOT NULL, deleted TINYINT(1) NOT NULL, INDEX IDX_986B61C04F34D596 (ad_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ad ADD shifts LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }
}
