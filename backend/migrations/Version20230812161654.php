 ...
 */
final class Version20230812161654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD to_user_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE user_id from_user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notification ADD user_id INT DEFAULT NULL, DROP from_user_id, DROP to_user_id, CHANGE description description VARCHAR(255) NOT NULL');
