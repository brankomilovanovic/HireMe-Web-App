...
class User extends BaseEntity implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\JoinColumn(name: "userCompany_id", referencedColumnName: "id", nullable: true)]
    #[Groups(['basic'])]
    private ?UserCompany $userCompany;

    #[ORM\ManyToOne(targetEntity: UserIndividual::class)]
    #[ORM\JoinColumn(name: "userIndividual_id", referencedColumnName: "id", nullable: true)]
    #[Groups(['basic'])]
    ...
    public function setUserIndividual(?UserIndividual $userIndividual): self
    {
